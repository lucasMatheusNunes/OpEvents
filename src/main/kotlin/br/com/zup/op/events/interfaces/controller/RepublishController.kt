...
@CrossOrigin(origins = ["http://localhost:3000"]) // Enabling CORS only for the local application. We will be changing the address as soon as it is implemented for production.
@RestController
